...
icon_plaintext = None
weather_icons = {
    "clear-day": customtkinter.CTkImage(dark_image=Image.open("clear-day.png"), size=(50, 50)),  # Sun
    "clear-night": customtkinter.CTkImage(dark_image=Image.open("clearnight.png"), size=(50, 50)),  # Moon
    "partly-cloudy-day": customtkinter.CTkImage(dark_image=Image.open("partly_cloudy_day.png"), size=(50, 50)),  # Sun behind cloud
    "partly-cloudy-night": customtkinter.CTkImage(dark_image=Image.open("barely_cloudy_night.png"), size=(50, 50)),  # Moon behind cloud
    "cloudy": customtkinter.CTkImage(dark_image=Image.open("cloudy.png"), size=(50, 50)),  # Cloud
    "fog": customtkinter.CTkImage(dark_image=Image.open("fog.png"), size=(50, 50)),  # Fog
    "wind": customtkinter.CTkImage(dark_image=Image.open("wind.png"), size=(50, 50)),  # Wind face
    "rain": customtkinter.CTkImage(dark_image=Image.open("rain.png"), size=(50, 50)),  # Cloud with rain
    "sleet": customtkinter.CTkImage(dark_image=Image.open("sleet.png"), size=(50, 50)),  # Cloud with snow and rain
    "snow": customtkinter.CTkImage(dark_image=Image.open("rain.png"), size=(50, 50)),  # Snowflake
    "hail": customtkinter.CTkImage(dark_image=Image.open("hail.png"), size=(50, 50)),  # Cloud with hail
    "thunderstorm": customtkinter.CTkImage(dark_image=Image.open("thunderstorm.png"), size=(50, 50)),  # Cloud with lightning and rain
    "null": customtkinter.CTkImage(dark_image=Image.open("null.png"), size=(50, 50))  # Question mark
}
...
icon = customtkinter.CTkLabel(root, image=weather_icons[icon_plaintext], text="")
icon.place(x=10, y=5)
